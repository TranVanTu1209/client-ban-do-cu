...
const Footer = () => {
  const [paymentMethods] = useState([
    ...
    },
    {
      id: "3",
      image:
        "https://cdn1.iconfinder.com/data/icons/banking-and-finance-35/64/Internet-banking-512.png",
    },
  ]);
  return (
    <div className={classes.Footer}>
      ...
      >
        <div>
          <p className='text-red lead'>
            Hotline chăm sóc khách hàng: 0362750487
          </p>
      ...
      <FooterRow
        ...
        linkItems={["Quy chế hoạt động Sàn GDTMĐT", "Bán hàng cùng chúng tôi"]}
      ></FooterRow>
      <FooterRow title='PHƯƠNG THỨC THANH TOÁN'>
        <div className={classes.PaymentMethods}>
          {paymentMethods.map((p) => (
            <img key={p.id} src={p.image} alt={p.image} />
          ))}
        </div>
      </FooterRow>
      <FooterRow title='KẾT NỐI VỚI CHÚNG TÔI'>
        ...
        <div className={classes.FooterDownloads}>
          ...
          <img
            src='https://www.sweego.vn/assets/appstore.png'
            alt='app store '
          />
          <img
